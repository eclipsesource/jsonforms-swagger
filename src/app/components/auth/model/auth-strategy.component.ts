...
import {compileToComponent} from '../../helpers/Helpers';
...
export class AuthStrategyComponent {
  ...
  ngOnInit(){
    this.dcl.loadNextToLocation(compileToComponent(this.strategy.getTemplate(), this.strategy, [require('../auth.css')], module.id), this.viewContainerRef)
  }
}
